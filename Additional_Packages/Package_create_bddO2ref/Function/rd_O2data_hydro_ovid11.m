...
case 'ov11me'
        if strcmp(datatype,'ctd') == 1
            ...
            tabo2fileid = cell(size(tabo2file,1),1);
            tabo2fileid{1} = 'm852_3';
            tabo2fileid{2} = 'm852_27';
            tabo2fileid{3} = 'm851_14';
            tabo2fileid{4} = 'm851_18';
            tabo2fileid{5} = 'm851_26';
            tabo2fileid{6} = 'm851_79';
            tabo2fileid{7} = 'm851_82';
            tabo2fileid{8} = 'm851_95';
            tabo2fileid{9} = 'm851_106';
            ...
            for ifile = 1:nfile
                ...
                switch fname(1:4)
                    case 'm852'
                        ...
                        refID{ifile} = sprintf('ov11me_%s',sta_id);% TR 28.01.2022
                        lat(ifile) = latf;
                        lon(ifile) = lonf;
                        juld(ifile) = juldf;
    ...
    case 'ov11di'
        if strcmp(datatype,'ctd') == 1
            ...
            for iprf = 1:29
                ...
                refID{iprf} = sprintf('ov11di_a16n2011_%d',iprf);%TR 28.01.2022
                nl = 1;
