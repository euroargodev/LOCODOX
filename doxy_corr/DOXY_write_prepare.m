...
% CONFIG.adjusted_error_abs et CONFIG.adjusted_error_rel sont des valeurs  num??riques
% j'ai donc supprim?? str2double dans la multiplication
% sinon l'on obtient NaN dans doxy_adjusted_error
% sans doute pas bon dans le cas de CHANGE_VALUES, mais rien modifi??
%--EB
