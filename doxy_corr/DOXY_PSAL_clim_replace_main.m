...
function DATA=DOXY_PSAL_clim_replace_main(DATA,WOA,Work)
%

% Read climatological fields
%
...
DATA=DOXY_PSAL_clim_replace_apply(ptype,DATA,Work,timeclim, depthclim, latclim, lonclim,psalclim,Work.PSAL_REPLACE_cycle_beg,Work.PSAL_REPLACE_cycle_end);
