...
switch CORR.whichO2quantity
    case 'DOXY'
        ...
        CORR.ppox_corr = O2ctoO2p(doxy,argoWork.temp_adjusted.data,argoWork.psal_adjusted.data,P);
    ...
    case 'PSAT'
        ...
        CORR.ppox_corr = O2stoO2p(CORR.psat_corr,argoWork.temp_adjusted.data,argoWork.psal_adjusted.data,P);
        
    case 'PPOX'
%         disp('correction pas appliquee ')
%         m=1;b=0;
        ...
        CORR.doxy_corr = DOXY_convert(CORR.doxy_corr,'mumol/L',CORR.unit,argoWork.an_dens.data);
        CORR.psat_corr = O2ptoO2s(CORR.ppox_corr,argoWork.temp_adjusted.data,argoWork.psal_adjusted.data,P);
