...
if isfield(Work,'NCEP_drift')
    Work.whichDrift=questdlg('Do you want to compute the Time Drift from WOA data or NCEP data ? ',sprintf('DRIFT COMPUTATION - %d',Work.wmo)','WOA','NCEP','WOA');
...
%         end
        ...
        fprintf('\t The Time Drift is computed on WOA data \n')   
    end
