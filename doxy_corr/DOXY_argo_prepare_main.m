...
% Lignes d??comment??es : %marine 17/06/19
...
if DATA.other.argo.n_prof ~= 0
    if ismember(Work.whichCorr,{'WOA','REF'})
        ...
        %psal/temp/pres from primary profile => la densit?? calcul??e (et
        %donc le PSAT) sera biais??e par rapport aux profondeurs du profil
        %Near-Surface.
