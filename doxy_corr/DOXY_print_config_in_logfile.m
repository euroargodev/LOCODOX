...
%   V2.0 12/04/2021 Thierry Reynaud Time Drift calculation variable renamed
%   min_drift_depth ==> min_drift_depth_deep
...
fprintf(log_summ,sprintf('- Minimum depth necessary for calculating the time drift in deeper levels: %s m \n', num2str(CONFIG.min_drift_depth_deep)));
fprintf(log_summ,'\n');
