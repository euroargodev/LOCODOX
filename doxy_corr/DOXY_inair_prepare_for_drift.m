...
%
% HISTORY
%   $created: 05/07/2019 $author: Marine GALLIAN, Altran Ouest
%   $Revision: version $Date: $author:

function [Work] = DOXY_inair_prepare_for_drift(CONFIG, WOA,...
...
if Work.NSIAfloat == 0
    ...
    argoTrajWork.inwater.psat.data = O2ctoO2s(tmpDoxy,argoTrajWork.profile.cellShape.temp_adjusted.data,argoTrajWork.profile.cellShape.psal_adjusted.data,P);
...
fprintf('INFO >>>>>    Optode height \n')   
disp([num2str(argo.heightoptode*100) ' cm']);  

NCEP.coloc.phum = watervapor(NCEP.coloc.air,0).* NCEP.coloc.rhum/100*1013.25;
NCEP.coloc.Pvap = Work.surface.argo.Pvap +(NCEP.coloc.phum - Work.surface.argo.Pvap).*log(argo.heightoptode/z0q)./log(10/z0q);
